<h1>Curso de Node.js + Express na prática</h1>
...
3 - Routes Params = @RequestParam do Spring boot e Query Params = @RequestParam do Spring boot só que com delimitadores.
